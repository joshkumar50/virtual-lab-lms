...
const labSchema = new mongoose.Schema({
  ...
  labType: {
    ...
    enum: ['LogicGateSimulator', 'PendulumLab', 'DoubleSlitLab', 'ChemistryLab', 'CircuitAnalysis', 'ArduinoLab']
  },
  instructions: {
    type: String,
  ...
  // Curriculum alignment for government schools
  boardAlignment: {
    type: String,
  ...
  // Lite mode: text-only instructions for low bandwidth
  liteModeInstructions: {
    type: String,
    default: null
  },
  liteModeAvailable: {
