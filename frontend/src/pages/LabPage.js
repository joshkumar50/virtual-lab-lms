...
const LabPage = () => {
  ...
  const labData = {
    ...
    6: {
      ...
      description: 'Investigate the motion of a simple pendulum and factors affecting its period.',
      type: 'physics',
      duration: '1 hour',
      objectives: [
        'Understand simple harmonic motion',
        'Analyze factors affecting pendulum period (length, mass, gravity)',
        'Verify the mathematical relationship T = 2π√(L/g)',
        'Practice data collection and error analysis'
      ]
    },
    7: {
      ...
      objectives: [
        ...
        'Understand GPIO and PWM',
        'Practice circuit integration',
        'Analyze embedded system behavior'
      ]
    }
  };
  ...
  const renderLabComponent = () => {
    switch (labId) {
      ...
      case '6':
        return <PendulumLab onComplete={handleLabComplete} />;
      case '7':
        return <ArduinoLab onComplete={handleLabComplete} />;
      default:
        return <LogicGateSimulator onComplete={handleLabComplete} />;
    }
  };
