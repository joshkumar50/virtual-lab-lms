...
import { Play, BookOpen, Zap, Atom, CircuitBoard, Beaker, Cpu } from 'lucide-react';
...
const PracticePage = () => {
  ...
  const practiceLabs = [
    ...
    },
    {
      ...
      description: "Investigate factors affecting the period of a simple pendulum.",
      labType: "Physics",
      difficulty: "Medium",
      duration: "30 min",
      icon: Atom,
    ...
    },
    {
      ...
      description: "Program and simulate Arduino Uno circuits using the Wokwi simulator. Learn embedded systems and GPIO control.",
      labType: "Embedded Systems",
      difficulty: "Medium",
      duration: "60 min",
      icon: Cpu,
      path: "/arduino-lab"
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                  ...
                  <span className={`px-2 py-1 rounded-full ${lab.difficulty === 'Easy' ? 'bg-green-100 text-green-800' :
