...
import PendulumLabStandalone from './pages/PendulumLabStandalone';
import ArduinoLabStandalone from './pages/ArduinoLabStandalone';
...
// Fallback to localhost:5000 if the environment variable is not defined
          ...
          <Router>
            <div className="App min-h-screen bg-gray-50">
              <Routes>
                ...
                <Route path="/register-school" element={<InstitutionRegistration />} />
                <Route path="/resources" element={<TeacherResourceCenter />} />

                {/* Protected routes */}
                <Route path="/manage-schools" element={<ProtectedRoute allowedRoles={['education_officer']}><ManageSchools /></ProtectedRoute>} />
                <Route path="/assignments" element={<ProtectedRoute><StudentAssignments /></ProtectedRoute>} />
                <Route path="/live-session" element={<ProtectedRoute><LiveSessionPage /></ProtectedRoute>} />
                <Route path="/live-session/:courseId" element={<ProtectedRoute><LiveSessionPage /></ProtectedRoute>} />
                ...
                <Route path="/course/:courseId/messages" element={
                  <ProtectedRoute>
                    <MessagesPage />
                  </ProtectedRoute>
                } />
                ...
                <Route path="/pendulum-lab" element={<PendulumLabStandalone />} />
                <Route path="/arduino-lab" element={<ArduinoLabStandalone />} />
              </Routes>
